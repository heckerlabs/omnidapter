...
async def test_create_connection_returns_authorization_url(
    ...
    with patch("omnidapter_api.routers.connections.Omnidapter") as MockOmni:
...
async def test_oauth_callback_transitions_to_active(
    ...
    with patch("omnidapter_api.routers.oauth.Omnidapter") as MockOmni:
    ...
    # Should redirect to the org's redirect_url
