...
uv run pytest apps/omnidapter-server/tests/unit/ -v
```
...
```
apps/omnidapter-server/tests/unit/test_auth_middleware.py   10 passed
apps/omnidapter-server/tests/unit/test_connection_state_machine.py  10 passed
apps/omnidapter-server/tests/unit/test_encryption.py        11 passed
apps/omnidapter-server/tests/unit/test_error_mapping.py      9 passed
apps/omnidapter-server/tests/unit/test_pagination.py         7 passed
apps/omnidapter-server/tests/unit/test_rate_limiting.py      6 passed
apps/omnidapter-server/tests/unit/test_usage_metering.py     5 passed
...
```bash
uv run pytest apps/omnidapter-server/tests/integration/ -v
```
...
```python
import pytest
from omnidapter_server.services.rate_limit import check_rate_limit, reset_org_state
