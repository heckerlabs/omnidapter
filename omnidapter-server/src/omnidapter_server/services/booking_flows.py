"""Shared booking endpoint orchestration flows."""
...
BookingOperation = Callable[[Any], Awaitable[Any]]
LastUsedUpdater = Callable[[uuid.UUID, AsyncSession], Awaitable[None]]


async def execute_booking_operation(
    *,
    connection_id: str,
    request: Request,
    ...
    try:
        ...
        result = await operation(lib_conn.booking())
