...
class Reminder(BaseModel):
    ...
    """ # noqa: E501
    use_default: Optional[StrictBool] = False
    overrides: Optional[List[ReminderOverride]] = None
    __properties: ClassVar[List[str]] = ["use_default", "overrides"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "use_default": obj.get("use_default") if obj.get("use_default") is not None else False,
            "overrides": [ReminderOverride.from_dict(_item) for _item in obj["overrides"]] if obj.get("overrides") is not None else None
        })
        return _obj
