...
class ConnectionsApi:
    ...
    def reauthorize_connection(
        self,
        connection_id: StrictStr,
        reauthorize_connection_request: ReauthorizeConnectionRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param connection_id: (required)
        :type connection_id: str
        :param reauthorize_connection_request: (required)
        :type reauthorize_connection_request: ReauthorizeConnectionRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._reauthorize_connection_serialize(
            connection_id=connection_id,
            reauthorize_connection_request=reauthorize_connection_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _reauthorize_connection_serialize(
        self,
        connection_id,
        reauthorize_connection_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if reauthorize_connection_request is not None:
            _body_params = reauthorize_connection_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/connections/{connection_id}/reauthorize',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
